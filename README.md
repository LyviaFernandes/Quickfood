...
![Tela](https://github.com/maridabrins/MD-QuickFood/blob/main/thumb.png)<br>
<!-- ---------------------------------------------------------------------- -->

<!-- MODELO DE COMO EXECUTAR O PROJETO -->
## 🚀 Como executar o projeto
1 - Baixar o Projeto (git clone)  <br>
`git clone https://github.com/LyviaFernandes/QuickFood.git`
...
- [QuickFood](https://github.com/LyviaFernandes/Quickfood/)
